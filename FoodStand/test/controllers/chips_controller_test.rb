...
class ChipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chip" do
    assert_difference('Chip.count') do
      post chips_url, params: { chip: { prices: @chip.prices, typesOfChips: @chip.typesOfChips } }
    end
  ...
  test "should update chip" do
    patch chip_url(@chip), params: { chip: { prices: @chip.prices, typesOfChips: @chip.typesOfChips } }

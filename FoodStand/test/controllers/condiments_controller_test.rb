...
class CondimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condiment" do
    assert_difference('Condiment.count') do
      post condiments_url, params: { condiment: { typesOfCondiments: @condiment.typesOfCondiments } }
    end
  ...
  test "should update condiment" do
    patch condiment_url(@condiment), params: { condiment: { typesOfCondiments: @condiment.typesOfCondiments } }

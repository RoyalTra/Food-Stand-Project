...
class BeveragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beverage" do
    assert_difference('Beverage.count') do
      post beverages_url, params: { beverage: { price: @beverage.price, typesOfDrinks: @beverage.typesOfDrinks } }
    end
  ...
  test "should update beverage" do
    patch beverage_url(@beverage), params: { beverage: { price: @beverage.price, typesOfDrinks: @beverage.typesOfDrinks } }

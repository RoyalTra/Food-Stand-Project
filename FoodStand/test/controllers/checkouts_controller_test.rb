...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post checkouts_url, params: { checkout: { checkout_id: @checkout.checkout_id, number,: @checkout.number,, number: @checkout.number, totalCost: @checkout.totalCost } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { checkout_id: @checkout.checkout_id, number,: @checkout.number,, number: @checkout.number, totalCost: @checkout.totalCost } }
